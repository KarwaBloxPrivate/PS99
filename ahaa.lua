...
if table.find(Accs, game.Players.LocalPlayer.Name) then
	...
	_G.GRANK_TO = 1
	_G.GZONE_TO = 1 -- ONLY increase above 99 to go to world2, only when 100% sure, there is no way back for the "best zone" quests etc. 
	_G.GMAX_EGG_SLOTS = 99
	_G.GMAX_EQUIP_SLOTS = 99
	_G.GHOLD_GIFTS = false
	_G.GHOLD_BUNDLES = false
	_G.GMAX_ZONE_UPGRADE_COST = 999999
	_G.GIGNORE_SLEDRACE = false
	_G.GPOTIONS = {"Damage","Coins"}
	_G.GPOTIONS_MAX_TIER = 99
	_G.GENCHANTS = {"Tap Power", "Coins", "Criticals", "Strong Pets", "Criticals"}
	_G.GGFX_MODE = 1
	_G.GDO_COLORS_INSTANCE = true
	_G.GWEBHOOK_USERID = "750423178240721007" -- your discord userID, rightclick your user & copy it, might need to enable DEV settings in discord.
	_G.GWEBHOOK_LINK = "https://discord.com/api/webhooks/1123611155303235604/he0sQyBFyGfMx5YIYYKVvNqYNMyWqIdvb7pkmUZ6slxrR1B4DXusPwUo0S42GjnCjHDj" -- a webhook on your
	script_key="PkFRaIkLWZQQCCItqNsdLjpQgmKxKZyB";
